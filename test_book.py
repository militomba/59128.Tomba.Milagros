...
class TestBook(unittest.TestCase):
    ...
    def test_constructor_vacio(self):
        book = Book()
        self.assertDictEqual(book._dict_, {'_name': '',
                                           '_authorName': '',
                                           '_memberLegajo': ''})
    ...
    def test_uso_property(self):
        ...
        book.memberLegajo = ''
        self.assertDictEqual(book._dict_,
    ...
    def test_constructor_con_valores_iniciales(self):
        ...
        self.assertDictEqual(book._dict_,  {'_authorName': 'PAULO COELHO',
                                            '_memberLegajo': '',
                                            '_name': 'EL ALQUIMISTA'})
    # *********
    # ** ServicesBook ***
    ...
    def test_add_book(self, name, authorName, memberLegajo):
        ...
        self.assertDictEqual(Repository.booksList[bookKey], book._dict_)
